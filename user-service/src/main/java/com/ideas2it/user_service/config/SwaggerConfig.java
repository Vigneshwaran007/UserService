...
public class SwaggerConfig {
	...
	private ApiInfo apiDetails() {
		return new ApiInfoBuilder().title("Health Care User Detail Management")
				.description("Detail documentation for user Rest API").license("HEALTHCARE").version("1.0").build();
	}
}
